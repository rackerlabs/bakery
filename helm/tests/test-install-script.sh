...
rg -q 'Skipping integrated Bakery DB bootstrap because no-local-bakery mode is enabled' "${INSTALL_SCRIPT}"
...
rg -q '/etc/platform-config/helm-chart-version.yaml' "${INSTALL_SCRIPT}"
rg -q '/srv/config/chart-versions.yaml' "${INSTALL_SCRIPT}"
