...
cp helm/overrides/bakery-only-overrides.yaml /srv/config/poundcake/poundcake-helm-overrides.yaml
...
cp helm/overrides/poundcake-only-overrides.yaml /srv/config/poundcake/poundcake-helm-overrides.yaml
