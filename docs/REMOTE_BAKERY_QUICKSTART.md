...
- Helm chart version is resolved by the installers from `/srv/config/chart-versions.yaml` by default.
...
Typical override path: `/srv/config/poundcake/poundcake-helm-overrides.yaml`.
