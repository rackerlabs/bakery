...
@click.option("--username", default=None, help="Username for passwzone-based providers")
@click.option("--password", default=None, help="Password for passwzone-based providers")
@click.pass_context
def login_cmd(
    ctx: click.Context,
    provider: str | None,
