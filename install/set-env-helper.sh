...
# /srv/config/chart-versions.yaml (key: poundcake) when present.
export POUNDCAKE_CHART_VERSION="${POUNDCAKE_CHART_VERSION:-}"
export POUNDCAKE_VERSION_FILE="${POUNDCAKE_VERSION_FILE:-/srv/config/chart-versions.yaml}"
...
export POUNDCAKE_BASE_OVERRIDES="${POUNDCAKE_BASE_OVERRIDES:-/opt/platform-config/base-helm-configs/poundcake/poundcake-helm-overrides.yaml}"
export POUNDCAKE_GLOBAL_OVERRIDES_DIR="${POUNDCAKE_GLOBAL_OVERRIDES_DIR:-/etc/platform-config/helm-configs/global_overrides}"
export POUNDCAKE_SERVICE_CONFIG_DIR="${POUNDCAKE_SERVICE_CONFIG_DIR:-/srv/config/poundcake}"
export POUNDCAKE_HELM_POST_RENDERER="${POUNDCAKE_HELM_POST_RENDERER:-/etc/platform-config/kustomize/kustomize.sh}"
export POUNDCAKE_HELM_POST_RENDERER_ARGS="${POUNDCAKE_HELM_POST_RENDERER_ARGS:-poundcake/overlay}"
export POUNDCAKE_HELM_POST_RENDERER_OVERLAY_DIR="${POUNDCAKE_HELM_POST_RENDERER_OVERLAY_DIR:-/etc/platform-config/kustomize/poundcake/overlay}"
...
echo "  Override dir: /srv/config/poundcake"
