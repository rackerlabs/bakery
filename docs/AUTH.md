...
In the lab, the deploy-time override file is `/srv/config/poundcake/poundcake-helm-overrides.yaml`.
...
auth:
  auth0:
    ...
    ui:
      ...
      callbackUrl: "https://poundcake.api.ord.example-domain.net/api/v1/auth/oidc/callback"
...
For the lab host `https://poundcake.api.ord.example-domain.net`:

- UI Auth0 app type: `Regular Web Application`
- CLI Auth0 app type: `Native Application`
- UI Allowed Callback URLs:
  - `https://poundcake.api.ord.example-domain.net/api/v1/auth/oidc/callback`
- UI Allowed Logout URLs:
  - `https://poundcake.api.ord.example-domain.net/`
...
./install/install-poundcake-helm.sh \
  -f /srv/config/poundcake/poundcake-helm-overrides.yaml
```
