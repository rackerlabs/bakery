...
- pull-secret reference fragments -> `/srv/config/poundcake/00-pull-secret-overrides.yaml`
- Gateway, database, remote Bakery, Bakery runtime, scaling, scheduling, and resource fragments -> `/srv/config/poundcake/10-main-overrides.yaml`
- auth provider fragments -> `/srv/config/poundcake/20-auth-overrides.yaml`
- Git sync fragments -> `/srv/config/poundcake/30-git-sync-overrides.yaml`
